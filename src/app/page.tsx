  ...
  return (
    <main className="flex-grow">
      ...
      <section className="bg-orange-50 py-12">
        <div className="flex flex-col gap-6 items-center container mx-auto text-center">
      ...
      <section className="py-12">
        <div className="flex flex-col items-center container mx-auto gap-8">
          ...
          <div className="grid md:grid-cols-3 w-[80%] gap-8">
            {recipes.map((recipe) => (
              <RecipeCard key={recipe.id} recipe={recipe} mostrarBotaoEditar={false} mostrarBotaoDeletar={false}/>
            ))}
          </div>
